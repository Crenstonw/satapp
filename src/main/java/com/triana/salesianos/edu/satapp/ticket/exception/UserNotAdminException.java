...
public class UserNotAdminException extends ErrorResponseException {
    public UserNotAdminException() {

        super(HttpStatus.NOT_FOUND, of("The user you try to assign is not an admin"), null);
    }

    public static ProblemDetail of(String message) {
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, message);
        problemDetail.setTitle("The user you try to assign is not an admin");
